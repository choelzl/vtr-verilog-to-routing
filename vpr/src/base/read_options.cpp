...
argparse::ArgumentParser create_arg_parser(std::string prog_name, t_options& args) {
    ...
    route_grp.add_argument<e_crosstalk_routing_strategy, ParseCrossTalkRoutingStrategy>(args.crosstalk_rs, "--crosstalk_rs")
        .help("Sets Custom Crosstalk routing strategies. Possible Values: B_CT, NONE")
        .default_value("NONE");
    ...
    route_grp.add_argument<bool, ParseOnOff>(args.crosstalk_sorting, "--crosstalk_sorting")
        .help("Sensitive sorting: if true, sorts first by sensitivity and then by sink number")
        .default_value("on");

    route_grp.add_argument<bool, ParseOnOff>(args.crosstalk_nn1, "--crosstalk_nn1")
